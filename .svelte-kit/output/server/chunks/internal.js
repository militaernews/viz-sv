import { H as HYDRATION_ERROR, B as BOUNDARY_EFFECT, E as ERROR_VALUE, k as EFFECT_RAN, l as define_property, r as run_all, U as UNOWNED, M as MAYBE_DIRTY, C as CLEAN, D as DERIVED, I as INERT, m as EFFECT, A as ASYNC, o as BLOCK_EFFECT, q as DEV, t as deferred, u as BRANCH_EFFECT, R as ROOT_EFFECT, v as DIRTY, w as DESTROYED, x as USER_EFFECT, y as INSPECT_EFFECT, S as STATE_SYMBOL, z as object_prototype, F as array_prototype, G as UNINITIALIZED, J as get_descriptor, K as get_prototype_of, L as is_array, N as is_extensible, O as EFFECT_PRESERVED, P as HEAD_EFFECT, Q as STALE_REACTION, T as EFFECT_TRANSPARENT, V as DISCONNECTED, W as REACTION_IS_UPDATING, X as index_of, Y as COMMENT_NODE, Z as HYDRATION_START, _ as HYDRATION_END, $ as array_from, a0 as is_passive_event, a1 as LEGACY_PROPS, a2 as render, a as push$1, a3 as setContext, p as pop$1 } from "./index2.js";
import { a as safe_equals, e as equals } from "./hooks.js";
import "clsx";
let base = "";
let assets = base;
const app_dir = "_app";
...
async function get_hooks() {
  ...
  let reroute;
  let transport;
  ({ reroute, transport } = await import("./hooks.js").then((n) => n.b));
  return {
    handle,
    handleFetch,
    handleError,
